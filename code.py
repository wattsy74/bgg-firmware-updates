FIRMWARE_VERSIONS = {
    ...
    "utils.py": "3.9.12",
    "gamepad.py": "3.9.12",
    "serial_handler.py": "3.9.12",
    "pin_detect.py": "3.9.12",
    "boot.py": "3.9.12",
    "demo_routine.py": "3.9.12",
    "demo_state.py": "3.9.12"
}

# BGG Firmware v3.9.12 - Smart Acknowledgment System
...
# - Maintains v3.9.12 stability with communication improvements
