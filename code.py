FIRMWARE_VERSIONS = {
    ...
    "utils.py": "3.9.14",
    "gamepad.py": "3.9.14",
    "serial_handler.py": "3.9.14",
    "pin_detect.py": "3.9.14",
    "boot.py": "3.9.14",
    "demo_routine.py": "3.9.14",
    "demo_state.py": "3.9.14"
}

# BGG Firmware v3.9.14 - Smart Acknowledgment System
...
# - Maintains v3.9.14 stability with communication improvements
