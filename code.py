FIRMWARE_VERSIONS = {
    ...
    "utils.py": "3.9.23",
    "gamepad.py": "3.9.23",
    "serial_handler.py": "3.9.23",
    "pin_detect.py": "3.9.23",
    "boot.py": "3.9.23",
    "demo_routine.py": "3.9.23",
    "demo_state.py": "3.9.23"
}

# BGG Firmware v3.9.23 - Smart Acknowledgment System
...
# - Maintains v3.9.23 stability with communication improvements
