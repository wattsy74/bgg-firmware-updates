FIRMWARE_VERSIONS = {
    ...
    "utils.py": "3.9.11",
    "gamepad.py": "3.9.11",
    "serial_handler.py": "3.9.11",
    "pin_detect.py": "3.9.11",
    "boot.py": "3.9.11",
    "demo_routine.py": "3.9.11",
    "demo_state.py": "3.9.11"
}

# BGG Firmware v3.9.11 - Smart Acknowledgment System
...
# - Maintains v3.9.11 stability with communication improvements
