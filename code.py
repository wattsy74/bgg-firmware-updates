FIRMWARE_VERSIONS = {
    ...
    "utils.py": "3.9.25",
    "gamepad.py": "3.9.25",
    "serial_handler.py": "3.9.25",
    "pin_detect.py": "3.9.25",
    "boot.py": "3.9.25",
    "demo_routine.py": "3.9.25",
    "demo_state.py": "3.9.25"
}

# BGG Firmware v3.9.25 - Smart Acknowledgment System
...
# - Maintains v3.9.25 stability with communication improvements
