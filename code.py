FIRMWARE_VERSIONS = {
    ...
    "utils.py": "3.9.13",
    "gamepad.py": "3.9.13",
    "serial_handler.py": "3.9.13",
    "pin_detect.py": "3.9.13",
    "boot.py": "3.9.13",
    "demo_routine.py": "3.9.13",
    "demo_state.py": "3.9.13"
}

# BGG Firmware v3.9.13 - Smart Acknowledgment System
...
# - Maintains v3.9.13 stability with communication improvements
