FIRMWARE_VERSIONS = {
    ...
    "utils.py": "3.9.15",
    "gamepad.py": "3.9.15",
    "serial_handler.py": "3.9.15",
    "pin_detect.py": "3.9.15",
    "boot.py": "3.9.15",
    "demo_routine.py": "3.9.15",
    "demo_state.py": "3.9.15"
}

# BGG Firmware v3.9.15 - Smart Acknowledgment System
...
# - Maintains v3.9.15 stability with communication improvements
