# serial_handler.py - High-Speed Streaming Version v3.9.7 (with JSON corruption protection)
__version__ = "3.9.7"
                    ...
                    if line == "END":
                        try:
                            ...
                            if filename.endswith(".json"):
                                ...
                                print(f"✅ File {filename} written successfully ({line_count} lines) - v3.9.7 High-Speed Streaming ⚡")
